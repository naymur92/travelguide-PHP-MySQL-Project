...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Contact Us - Travel Guide BD</title>
...
<body>
				...
				<div class="faq-content col-lg-9 col-md-9">
					<div class="single-faq">
						<h2 class="text-uppercase">
							Do we ensure coustomer security?
						</h2>
						<p>
	...
	<section class="">
		<div class="container">
			<h1 class="text-center mb-40">Google Map Location</h1>
			<div style="width: 100%; margin-top: 20px;">
				<iframe scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=400&amp;hl=en&amp;q=IDB%20Bhaban,%20Dhaka,%20Bangaladesh+(Travel%20Guide%20BD)&amp;t=&amp;z=16&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="600" frameborder="0"><a href="https://www.gps.ie/wearable-gps/">gps smartwatches</a></iframe>
			</div>
		</div>		
	</section>
	...
	<!-- start contact Area -->		
	<section class="contact-area mt-40" id="contact">
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="menu-content pb-60 col-lg-8">
					<div class="title text-center">
