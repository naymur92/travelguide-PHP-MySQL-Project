			...
			<div class="row">
				<div class="col-lg-5 col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h2 class="mb-5">About Travel Guide BD</h2>
			    		...
			    		<p class="footer-text">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">TravelGuide</a></p>
					</div>
				</div>
				<div class="col-lg-5  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<ul class="footer-menu mb-20">
							<li><a href="#">&gt;Columbus Travel Pro</a></li>
							<li><a href="#">&gt;Advertiser T's and C's</a></li>
							<li><a href="#">&gt;Contributors T's &amp; C's</a></li>
							<li><a href="#">&gt;Conditions for use</a></li>
							<li><a href="#">&gt;Conditions for Sales of Goods</a></li>
						...
						<div class="" id="mc_embed_signup">
							<form target="_blank" novalidate="true" method="get" class="form-inline">
								<div class="d-flex flex-row">
									...
									<button type="submit" name="submit" class="click-btn btn btn-default"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
								</div>		
								<div class="info"></div>
							</form>
						</div>
