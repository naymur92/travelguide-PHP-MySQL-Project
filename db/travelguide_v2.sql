...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2022 at 08:04 PM
...
CREATE TABLE `bookings` (
  ...
  `package_price` mediumint(7) UNSIGNED NOT NULL,
...
INSERT INTO `bookings` (`b_id`, `user_id`, `package_id`, `package_price`, `booking_time`, `journey_date`, `booking_status`, `extra_info`, `total_person`, `payment_id`) VALUES
(1, 3, 26, 135000, '2022-10-28 23:27:09', '2022-10-30', 'Pending', '5* Hotel', 2, 0),
(2, 3, 26, 135000, '2022-10-28 23:34:29', '2022-10-31', 'Pending', '5* Hotel', 2, 0),
(3, 3, 26, 135000, '2022-10-28 23:37:41', '2022-10-30', 'Pending', '', 1, 0),
(4, 3, 26, 135000, '2022-10-28 23:38:49', '2022-10-31', 'Pending', '', 1, 1),
(5, 3, 27, 3000, '2022-10-28 23:39:46', '2022-10-30', 'Pending', '3* Hotel', 3, 2),
(6, 4, 26, 135000, '2022-10-28 23:55:49', '2022-10-30', 'Pending', '5* Hotel', 3, 3);
...
INSERT INTO `payments` (`pmt_id`, `booking_id`, `user_id`, `payment_gatway`, `transaction_id`, `sender_number`, `payment_status`, `payment_time`) VALUES
(1, 4, 3, 'rocket', 'qd5asedf98s', '01558981652', 'Pending', '2022-10-28 23:38:49'),
(2, 0, 3, 'nagad', 'adg4343', '01558981652', 'Pending', '2022-10-28 23:39:46'),
(3, 6, 4, 'rocket', 'asdfafdg34q5', '01558981652', 'Pending', '2022-10-28 23:55:49');
...
--
ALTER TABLE `bookings`
  MODIFY `b_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `payments`
  MODIFY `pmt_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
