...
--
-- Host: localhost
-- Generation Time: Sep 17, 2022 at 03:01 PM
...
--
ALTER TABLE `packages`
  MODIFY `p_id` smallint(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
